...
| Compiled planner | `keel plan specify|research|tasks|check` turns a request into versioned requirements, research, architecture, tasks, and a checked requirement traceability matrix before implementation. |
...
| Compile and check a delivery plan | `keel plan specify --request "..."`, `keel plan research --plan <id>`, `keel plan tasks --plan <id>`, `keel plan check --rtm --plan <id>` |
