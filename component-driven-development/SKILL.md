...
allowed-tools: Read, Grep, Glob, Edit, Write, Bash(keel memory:*), Bash(keel review pre-pr), Bash(git diff:*), Bash(git status), Bash(npm:*), Bash(yarn:*), Bash(pnpm:*), Bash(npx:*), Bash(dart:*), Bash(flutter:*)
effort: medium
---
