...
The native `keel memory retrieve` command is **implemented** as a cross-family lexical search (`--query`). Richer ranking remains a product direction; the live shape:
