...
| Planning and evidence-bound TODOs | `docs/planner.md`; `plan_workflow_test.rs`; `task_ticket_test.rs`; governed `plan update` publication. | **Implemented** for the shipped planner path. |
