...
| --- | --- | --- | --- |
| Classic (Stack A) | Cursor, Antigravity, Claude-class, and Muse hosts using `initialize` | `initialize` + silent `notifications/initialized` for `2024-11-05`, `2025-03-26`, `2025-06-18`, and `2025-11-25` (also accepts `2026-07-28` on `initialize` when offered) | Not required; missing `_meta` soft-defaults after classic handshake |
