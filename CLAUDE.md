...
- **Technique/process skills** (`brainstorming`, `writing-user-stories`, `running-a-sprint`, `test-driven-development`, `behavior-driven-development`, `domain-driven-design`, `systematic-debugging`, `writing-plans`, `executing-plans`, `subagent-driven-development`, `dispatching-parallel-agents`, `using-git-worktrees`, `finishing-a-development-branch`, `receiving-code-review`, `writing-skills`, `designing-agent-teams`, `compounding-knowledge`, `adversarial-security-review`, `compression-discipline`, `output-economy`, `critic`, `deliberation`, `research-enforcement`, `memory-consolidation`, `component-driven-development`) — main-thread skills with **no** subagent or managed profile. The distinguishing rule: a specialist ships three artifacts (SKILL.md + subagent + profile); a technique skill ships only SKILL.md.
