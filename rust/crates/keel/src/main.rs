//! Purpose: Entrypoint for the native keel Rust binary.
//! Caller: Operating system process launch via cargo build artifact or installed binary.
//! Dependencies: args, commands, help, json, manager, review, runner, runtime, utility modules and Rust keel crates.
//! Main Functions: main.
