...
pub const HOOK_EVENTS: &[HookEvent] = &[
    ...
    HookEvent {
        ...
        //      documented behavior.
        // Cost: spawning keel on every tool call is microseconds.
    ...
    // `keel hook message-display`, but skip it on install: a handler
...
/// Find a row by the kebab-case `keel hook <slug>` subcommand.
