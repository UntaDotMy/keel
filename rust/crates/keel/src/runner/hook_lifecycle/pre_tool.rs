...
use super::{
    append_compression_hint_when_forced, append_managed_hooks, base64_decode,
    brief_gate_blocks_path, brief_gate_max_blocks, brief_gate_message, brief_gate_mode,
    brief_is_fresh, brief_written_this_session, build_hooks_payload, build_session_summary,
    ...
    ensure_hooks_object, ensure_skill_listing_budget_fraction, evaluate_learned_skill_gate,
    file_mtime_ms, gate_mode, gate_mode_value, gate_status_rows, hook_session_id, hook_str,
    hook_tool_name, increment_counter_file, is_edit_class_tool, is_help_argument,
    is_managed_args_form, is_managed_hook_command, is_managed_hook_command_with_depth,
    is_managed_hook_entry, is_secret_key, learned_skill_gate_blocks_path,
    learned_skill_gate_max_blocks, learned_skill_gate_message, learned_skill_gate_mode,
    lifecycle_additional_context, managed_hook_command, managed_hook_entry, mask_secret_value,
    ...
    sanitize_memory_key, session_edit_stats, session_has_research_tool, session_start_context,
    ...
    today_date_string, truncate_on_line_boundary, user_config_or_env_u64,
    ...
    HookDiagnostics, ManagedHookEntry, SessionEditStats, SessionSummary, BRIEF_GATE_ENV_VAR,
