...
allowed-tools: Read, Grep, Glob, Edit, Write, Bash(claude-skills memory:*), Bash(git diff:*), Bash(git status), Bash(npm:*), Bash(node:*), Bash(npx:*), Bash(python:*), Bash(curl:*), Bash(openssl:*)
effort: medium
paths:
  - "**/auth/**"
  - "**/*auth*.ts"
